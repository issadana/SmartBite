<?php
    ...
    function adminExists($con, $email) {
    ...
    function handleAdd($con, $username, $email, $pass, $age, $gender) {
        $query = "INSERT INTO `user` (`id`, `username`, `email`, `password`, `age`, `role`, `login_status`, `gender`) VALUES (NULL, '$username', '$email', '$pass', '$age', 'admin', '0', '$gender')";
        if (mysqli_query($con, $query)) {
